...
class Sql extends \Core\baseGenerator {
	...
	private function parseField($field) {
		...
		if($field["default"] != 'null') { $sql .=  " DEFAULT '".(($field["default"] === "true")?"1":(($field["default"] === "false")?"0":$field["default"]))."'"; }
		if($field["null"] == false) { $sql .=  " NOT NULL"; }
		if($field["name"] == "ID") { $sql .= " AUTO_INCREMENT"; }
		return $sql;
	}
