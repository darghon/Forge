...
class UnitTests extends \Forge\ObjectGenerator
{
    ...
    public function generate()
    {
        ...
        foreach ($schema as $table_name => &$table) {
            ...
            unset($links);
            \Forge\Generator::getInstance()->build('datalayertest', [$table_name, $fields, $translation, $extends['Data'], $implements['Data']]);
            \Forge\Generator::getInstance()->build('businesslayertest', [$table_name, $fields, $translation, $extends['Business'], $implements['Business']]);
