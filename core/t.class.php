...
class T {
	 ...
	 * @var Array 
	 */
	protected static $lang_buffer = array();

	/**
	 * function that translates a string into the active language if possible.
	 * you can pass parameters into the text by adding {} around them, you can then fill them in by passing that value as a parameter
	 * You can also automatically use plural forms of words if wanted by adding all forms into {} devided by a |
	 * The system will consider the 1st entry as the single form, 2nd as other forms (plural)
	 * You need to pass a un-indexed number in the params array to trigger this process, otherwise "0" is assumed
	 * Ex. __("examples","I have {n} {book|books}.",array(2)); => I have 2 books.
	 * @param String $category
	 * @param String $text to be translated
	 * @param Array $params optional passed parameters
	 */
	public static function __($cat, $text, $params = array()) {
